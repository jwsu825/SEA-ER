...
# most of the train code are modifed from CGLB repo
import os
import pickle
import time
import traceback
...
if __name__ == '__main__':
    ...
    parser.add_argument("--gpu", type=int, default=0, help="which GPU to usnvidia-smie.")
    ...
    parser.add_argument('--method', type=str,
                        choices=["bare", 'jointtrain', 'ergnn', 'joint','Joint'], default="ergnn",
                        )
    
    parser.add_argument('--ir', type=strtobool, default=True,
                        help='whether to include the proposed importance reweighting method')
    ...
    parser.add_argument('--ILmode', default='taskIL',choices=['taskIL'])
    ...
    parser.add_argument('--perform_testing', type=strtobool, default=True, help='whet her to check the existence of processed data by loading')
    ...
    #command input
    method_args = {'ergnn': args.ergnn_args, 'bare': args.bare_args, 'joint': args.joint_args}
    ...
    print(f"Finishing the epoch in {toc - tic:0.4f} seconds")
